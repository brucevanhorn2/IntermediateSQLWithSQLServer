...
EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPaneCount' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwStudentsMajors'
GO

EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vwStudentsMajors'
GO

/****** Object:  View [dbo].[vwStudentsMajors]    Script Date: 6/7/2018 1:14:48 PM ******/
DROP VIEW [dbo].[vwStudentsMajors]
GO
